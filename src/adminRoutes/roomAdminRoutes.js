...
/**
 * @route   GET /api/admin/rooms/get-all-rooms
 ...
 */
router.get('/rooms/get-all-rooms', protect, authorizeRoles('admin'), getAllRooms);

/**
 * @route   GET /api/admin/rooms/search-rooms
 ...
 */
router.get('/rooms/search-rooms', protect, authorizeRoles('admin'), getFilteredRooms);

/**
 * @route   GET /api/admin/rooms/room-statistics
 ...
 */
router.get('/rooms/room-statistics', protect, authorizeRoles('admin'), getRoomStatistics);

/**
 * @route   GET /api/admin/rooms/get-room-usage-analysis
 ...
 */
router.get('/rooms/get-room-usage-analysis', protect, authorizeRoles('admin'), getRoomUsageAnalysis);

/**
 * @route   GET /api/admin/rooms/get-room-by-id/:id
 ...
 */
router.get('/rooms/get-room-by-id/:id', protect, authorizeRoles('admin'), getRoomById);
